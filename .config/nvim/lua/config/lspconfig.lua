vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(event)
		...
		map("<leader>lre", vim.lsp.buf.rename, "[L]SP [R][e]name")
		...
		map("gd", require("telescope.builtin").lsp_definitions, "[L]SP [D]efinition")
		...
		map("<leader>ls", require("telescope.builtin").lsp_document_symbols, "[L]Open Document [S]ymbols")
		...
		map("gs", vim.diagnostic.open_float, "[G]oto Diagnostic[S]")
